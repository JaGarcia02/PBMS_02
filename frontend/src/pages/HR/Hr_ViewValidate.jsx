            ...
            <div className="w-[99%] h-full flex flex-col rounded  relative">
              <table className="flex w-full justify-start flex-col items-start ">
                <tr className="w-full justify-evenly shadow-md shadow-gray-400 flex h-8  items-center prdc-color">
                  ...
                  <th className="text-[11px] text-white flex  w-[100%]">
                    <div className=" flex h-8 w-[100%] border-black border rounded-md relative text-black shadow-sm shadow-gray-600 bg-white dark:(bg-gray-600 text-light-50 shadow-none) <md:(w-[100%])">
                ...
                {allRequest
                  ...
                  .map((data, index) => (
                    ...
                    >
                      ...
                      <td
                        className={`text-[11px] arial-narrow-bold flex text-black  w-[100%]${
                          data.canceled_by
                            ? "  text-red-900"
                            : data.finished_by
                            ? " text-blue-900"

...
const HrUpdateEmploymentType = ({
  ...
  const sumbit_UpdateContractType = (e) => {
    e.preventDefault();
    if (updateContractType.activator.trim() == "") {
      setCheckEmpty(true);
    } else {
      axios
        .put(
          API_URL_HR + `update-employment-category/${updateContractType.ID}`,
          {
            employment_category: updateContractType.activator,
          }
        )
        .then((res) => {
  ...
  // Notify Update
  const notify_Update = () => {
    toast.info("Employment Category Updated", {
    ...
    >
      <motion.div className="absolute bg-white h-80 w-120 items-center shadow-md shadow-gray-900 z-999">
        <div className="w-full h-full flex flex-col item-center text-center mb-5">
          <div className=" prdc-color w-full h-25">
            ...
            <div className="flex items-center">
              ...
              <AiOutlineCloseSquare
                onClick={() =>
                  setUpdateContractType({ activator: null, ID: null })
                }
          ...
          <form className="w-full" onSubmit={sumbit_UpdateContractType}>
            <div className="flex justify-center items-center w-[100%] mt-16.5">
              ...
              <input
                ...
                className={`border-[2.5px] ${
                  updateContractType.activator == "" && checkEmpty
                    ? "border-red-500"
                    : "border-gray-500"
                ...
                value={updateContractType.activator}
              />
            </div>
...
export default HrUpdateEmploymentType;

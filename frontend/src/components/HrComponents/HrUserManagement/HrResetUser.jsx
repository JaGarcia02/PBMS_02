...
//                 className="w-25 h-7 text-white mr-3 rounded-sm text-[12px] flex items-center justify-center  hover:border-blue-500 border-0  disabled:(bg-gray-400 shadow-gray-800 cursor-not-allowed hover:bg-gray-500 hover:rounded-md)  "
//                 style={{ backgroundColor: "#006E04" }}
//               >
...
//               className="w-35 h-7 prdc-color text-white mr-3  text-[12px] arial-narrow-bold rounded-sm flex items-center justify-center disabled:(bg-gray-400 shadow-gray-800 cursor-not-allowed hover:bg-gray-500)"
...
//                 className="w-30 h-7 bg-yellow-500 mr-3 shadow-sm text-[12px] rounded-sm arial-narrow-bold text-white flex items-center justify-center  hover:border-red-500 border-0  disabled:(bg-gray-400 cursor-not-allowed hover:bg-gray-500 hover:rounded-md) "
//               >
...
//                 className="w-30 h-7 bg-red-600 mr-3 text-white arial-narrow-bold text-[12px] rounded-sm shadow-sm flex items-center justify-center disabled:(bg-gray-400 shadow-gray-800 cursor-not-allowed hover:bg-gray-500 hover:rounded-md)"
//               >
//                 <BsPersonFillDash className="mr-1 text-[15px] text-white " />{" "}
//                 Deactivate
//               </button>
//             ) : (
//               <button

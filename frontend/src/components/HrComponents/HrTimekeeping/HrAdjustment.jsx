...
const HrAdjustment = ({ setToggle, ObjFilter, chosenDate, CutOff }) => {
  return (
    <div className="flex flex-col w-full  p-1 items-center overflow-hidden">
      ...
      <div className="w-[98%] h-[90%] flex  flex-col overflow-y-auto ">
        <div className="w-[98%] text-black mt-3 arial-narrow-bold items-center justify-start flex flex-col">
          <span className=" text-13px w-full"> REGULAR</span>
          <table className="w-[100%]   border-spacing-4 border-transparent mt-2 overflow-hidden">
            <thead>
              <tr className="  arial-narrow-bold  text-black text-[12px] border-gray-500 border w-full h-10 rounded-md flex items-center bg-blue-200   dark:(bg-blue-500) <md:(hidden)">
                ...
                <th className="w-[12%]">REG</th>
                <th className="w-[12%]">OT</th>
                <th className="w-[12%]">UT</th>
                <th className="w-[13%]">ND</th>
                <th className="w-[13%]">LWP</th>
                <th className="w-[12%]">REGNS</th>
                <th className="w-[12%]">OTNS</th>
                <th className="w-[12%]">OTND</th>
                <th className="w-[12%]">LATES</th>
                <th className="w-[12%]">ABSENT</th>
                <th className="w-[12%] ">
        ...
        <div className="w-[98%] text-black mt-3 arial-narrow-bold items-center justify-start flex flex-col">
          <span className=" text-13px w-full"> SPECIAL HOLIDAY</span>
          <table className="w-[100%]   border-spacing-4 border-transparent mt-2 overflow-hidden">
            <thead>
              <tr className="  arial-narrow-bold  text-black text-[12px] border-gray-500 border w-full h-10 rounded-md flex items-center bg-blue-200   dark:(bg-blue-500) <md:(hidden)">
                <th className="w-[14%]">Date</th>
                <th className="w-[12%]">SH</th>
                <th className="w-[12%]">SH-OT</th>
                <th className="w-[12%]">SH-NS</th>
                <th className="w-[13%]">SH-ND</th>
                <th className="w-[12%]">SH-OTNS</th>
                <th className="w-[12%]">SH-OTND</th>
                <th className="w-[12%]">SH-LATES</th>
                <th className="w-[12%] ">
                  <BsFillPlusCircleFill className="h-4 w-4 text-black cursor-pointer" />
                </th>
              </tr>
        ...
        <div className="w-[98%] text-black mt-3 arial-narrow-bold items-center justify-start flex flex-col">
          <span className=" text-13px w-full"> LEGAL HOLIDAY</span>
          <table className="w-[100%]   border-spacing-4 border-transparent mt-2 overflow-hidden">
            <thead>
              <tr className="  arial-narrow-bold  text-black text-[12px] border-gray-500 border w-full h-10 rounded-md flex items-center bg-blue-200   dark:(bg-blue-500) <md:(hidden)">
                <th className="w-[14%]">Date</th>
                <th className="w-[12%]">LHS</th>
                <th className="w-[12%]">LHD</th>
                <th className="w-[12%]">LHD-OT</th>
                <th className="w-[13%]">LHD-NS</th>
                <th className="w-[13%]">LHD-ND</th>
                <th className="w-[12%]">LHD-OTNS</th>
                <th className="w-[12%]">LHD-OTND</th>
                <th className="w-[12%]">LHD-LATES</th>
                <th className="w-[12%] ">
                  <BsFillPlusCircleFill className="h-4 w-4 text-black cursor-pointer" />
                </th>
              </tr>
        ...
        <div className="w-[98%] text-black mt-3 arial-narrow-bold items-center justify-start flex flex-col">
          <span className=" text-13px w-full"> REST DAY</span>
          <table className="w-[100%]   border-spacing-4 border-transparent mt-2 overflow-hidden">
            <thead>
              <tr className="  arial-narrow-bold  text-black text-[12px] border-gray-500 border w-full h-10 rounded-md flex items-center bg-blue-200   dark:(bg-blue-500) <md:(hidden)">
                <th className="w-[14%]">Date</th>
                <th className="w-[12%]">RD</th>
                <th className="w-[12%]">RD-OT</th>
                <th className="w-[12%]">RD-NS</th>
                <th className="w-[13%]">RD-ND</th>
                <th className="w-[12%]">RD-OTNS</th>
                <th className="w-[12%]">OTND</th>
                <th className="w-[12%]">LATES</th>
                <th className="w-[12%]">ABSENT</th>
                <th className="w-[12%] ">
